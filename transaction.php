    ...
    <aside
        ...
        <div class="flex items-center gap-3 px-2 mb-10">
            <div class="w-10 h-10 rounded-full bg-primary flex items-center justify-center overflow-hidden">
                <img alt="Organization Logo"
                    data-alt="Minimalist geometric logo icon for a financial institution, solid emerald green background with white architectural lines"
                    src="https://lh3.googleusercontent.com/aida-public/AB6AXuAaPASis0KPsWyUEvFdgTwWKQjyIuZrzg211shNZw3XcNmsGo6ldpJK9-W9coB3WAA0hRAMNivKHVgWJ_XBqsC3COZUnvQnoslTdR10lUL98wkssB2bRqnAYqia1M6epRce9cUzeZRCWokEl-BrEyBD2wBNwMoH2-WxS6KiIHYNogBemV9tu6GhOeoTWaK-06iby9hXmnkkVR-_iyWIDy6PeKLDrcd5UiDP-Rg3yGfgHWj3FOB35n7NzeGJ_TOPTclQ1xsEwFiOAEN9" />
            </div>
            <div>
                <h1 class="text-xl font-bold text-emerald-800 dark:text-emerald-100 font-['Manrope'] tracking-tight">
                    Sovereign Ledger</h1>
                <p class="text-[10px] font-bold text-primary-container tracking-widest uppercase opacity-70">
                    Institutional Grade</p>
            </div>
        </div>
        <nav class="flex-1 space-y-2">
            ...
            <a class="flex items-center gap-3 px-4 py-3 text-emerald-700 dark:text-emerald-400 font-bold bg-white dark:bg-slate-800 shadow-sm rounded-lg translate-x-1 transition-transform font-['Manrope'] tracking-tight"
                ...
                <span class="material-symbols-outlined" data-icon="account_balance_wallet"
        ...
        <div class="mt-auto pt-6 border-t border-slate-100/50">
            <div class="flex items-center gap-3 px-2">
                <img alt="User Profile" class="w-8 h-8 rounded-full border border-outline-variant/20"
                    data-alt="Professional headshot of a financial executive in a crisp suit, soft office background with bokeh"
                    src="https://lh3.googleusercontent.com/aida-public/AB6AXuAdsyLdEkNXHHwei1aNfpDWr5ZDnmwEC_tYHpuuNRlxukHrsHlQ3clCPm4sErDAaF6Ois634PEp_rWUaAvGARqJ-7lIeQ9TS6VlGzC9aWeEwIBfYVPk6UQ5HhZ807YLlf79PbI8cUkhDjstLlgjDvtY7omzpEv1AJilQK73tmugAQSwVw7O1c6d4PygdO-hv78d9u_WJ-jsYz_lPC6Xo553KJeqgxcRKVRvpsmpUfyF7yzf51b676IKKicbtoeU79M1AxRdpXz_s6in" />
    ...
    <header
        ...
        <div class="flex items-center flex-1 max-w-xl">
            <div class="relative w-full group">
                ...
                <input
                    class="w-full bg-surface-container-low border-none rounded-full py-2 pl-10 pr-4 text-sm focus:ring-2 focus:ring-emerald-500/20 transition-all placeholder:text-outline/60"
