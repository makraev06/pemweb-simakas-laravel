...
<a class="flex items-center gap-3 px-4 py-3 text-slate-500 dark:text-slate-400 hover:text-emerald-600 font-['Manrope'] font-semibold tracking-tight hover:bg-slate-200/50 dark:hover:bg-slate-800/50 transition-colors rounded-lg group" href="#">
...
<img alt="Organization Logo" class="w-10 h-10 rounded-full object-cover" data-alt="professional portrait of a financial executive in a dark suit with soft office lighting background" src="https://lh3.googleusercontent.com/aida-public/AB6AXuA94bsvsu3DF9FsfcxkEF2_xGpr5GF2yhgQaPEnXvFfRWLUIMlrjf1CUJ4dW6Dsie2lECYJuCTD_8TioALTLJE6zT2kpkKfwt2cV4rRISGqLEcg0OOnCaRBLsQvrL0i73_8GURyAofC5gYybD20diaFdjtqS5Q8nX79nc9IvY1kRRcl3VoYjslpYMaj_fnyzUcYxLHwg2F-LMPvegkgbRTWoEZsCxDx35dzgBF-OcTFgn66tzgygGqkrod6DBWwnAbZ98PuUdJSjZOF"/>
...
<span class="material-symbols-outlined absolute left-3 top-1/2 -translate-y-1/2 text-slate-400 text-lg group-focus-within:text-emerald-600 transition-colors">search</span>
<input class="w-full bg-surface-container-low border-none rounded-full py-2 pl-10 pr-4 text-sm focus:ring-2 focus:ring-emerald-500/20 placeholder:text-slate-400 transition-all" placeholder="Search global ledger..." type="text"/>
</div>
</div>
<div class="flex items-center gap-6">
<button class="relative text-slate-500 dark:text-slate-400 hover:text-emerald-500 transition-colors">
<span class="material-symbols-outlined">notifications</span>
<span class="absolute top-0 right-0 w-2 h-2 bg-emerald-600 rounded-full border-2 border-white dark:border-slate-950"></span>
</button>
...
<h2 class="text-4xl font-bold text-on-background tracking-tight">Add Transaction</h2>
</div>
...
<div class="space-y-2">
<label class="text-[0.6875rem] font-bold text-on-surface-variant uppercase tracking-widest">Transaction Type</label>
<div class="relative group">
<select class="w-full bg-surface-container-low border-none rounded-lg py-3 px-4 appearance-none focus:ring-2 focus:ring-emerald-500/10 transition-all font-medium">
...
<div class="space-y-2">
<label class="text-[0.6875rem] font-bold text-on-surface-variant uppercase tracking-widest">Total Amount</label>
<div class="relative">
<span class="absolute left-4 top-1/2 -translate-y-1/2 text-slate-400 font-bold">$</span>
<input class="w-full bg-surface-container-low border-none rounded-lg py-3 pl-8 pr-4 focus:ring-2 focus:ring-emerald-500/10 transition-all font-['Manrope'] font-bold text-xl" placeholder="0.00" type="number"/>
</div>
</div>
</div>
<!-- Account Selection -->
<div class="space-y-2">
<label class="text-[0.6875rem] font-bold text-on-surface-variant uppercase tracking-widest">Target Account</label>
<div class="relative group">
<select class="w-full bg-surface-container-low border-none rounded-lg py-3 px-4 appearance-none focus:ring-2 focus:ring-emerald-500/10 transition-all font-medium">
...
<span class="material-symbols-outlined absolute right-3 top-1/2 -translate-y-1/2 pointer-events-none text-slate-400">account_balance</span>
</div>
</div>
<!-- Description -->
<div class="space-y-2">
<label class="text-[0.6875rem] font-bold text-on-surface-variant uppercase tracking-widest">Description</label>
<input class="w-full bg-surface-container-low border-none rounded-lg py-3 px-4 focus:ring-2 focus:ring-emerald-500/10 transition-all" placeholder="e.g. Q4 Institutional Liquidity Injection" type="text"/>
</div>
<!-- Additional Notes -->
<div class="space-y-2">
<label class="text-[0.6875rem] font-bold text-on-surface-variant uppercase tracking-widest">Additional Notes</label>
<textarea class="w-full bg-surface-container-low border-none rounded-lg py-3 px-4 focus:ring-2 focus:ring-emerald-500/10 transition-all resize-none" placeholder="Detailed audit trail or internal context..." rows="4"></textarea>
</div>
<!-- Actions -->
<div class="pt-6 flex items-center justify-end gap-4">
<button class="px-8 py-3 rounded-lg text-emerald-700 font-bold hover:bg-surface-container-high transition-all" type="button">
                  Cancel
                </button>
<button class="px-10 py-3 bg-gradient-to-br from-primary to-primary-container text-white font-bold rounded-lg shadow-lg hover:shadow-emerald-900/10 active:scale-[0.98] transition-all" type="submit">
                  Save Transaction
                </button>
</div>
</form>
...
<div class="absolute top-0 right-0 w-32 h-32 bg-white/5 rounded-full -mr-16 -mt-16 blur-3xl group-hover:bg-white/10 transition-colors"></div>
<p class="text-[0.6875rem] font-bold uppercase tracking-widest text-emerald-400 mb-6">Entry Preview</p>
<div class="space-y-4">
...
<p class="text-xs text-on-surface-variant leading-relaxed">
              All transactions exceeding $10,000 USD require a secondary authorization by the regional director. Ensure all additional notes contain the necessary project codes for audit reconciliation.
            </p>
<a class="inline-flex items-center text-xs font-bold text-emerald-600 hover:gap-2 transition-all" href="#">
              Read Protocol Documentation <span class="material-symbols-outlined text-sm ml-1">arrow_forward</span>
</a>
</div>
<!-- Visual Decoration Image -->
<div class="rounded-xl overflow-hidden h-40 relative group">
<img alt="Financial Analytics" class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-700" data-alt="clean minimal aesthetic of a high-tech trading floor with glowing green digital stock charts reflected in glass surfaces" src="https://lh3.googleusercontent.com/aida-public/AB6AXuDh2YMD1OPtBZ9vS8HqLLVcjxMOBhfl7-NugvONkEWYGgZZl7W_tE3YhK9CDO7gasggIUExFIi-5Y0umlzprrwjMyNZcCF5jlJlmS4_lG3Sa0JcFYrF2W8KF_xjR7yiZfnl76BxyqaPa-fHP7te_P3VsJAF5CKMsTWK0Gv_57O5-kh9BYhrP4im-SlHhKgK4il2bbS35x92t4XuKCQ2BEFNnFjB1-wJYgInhFnND1ytI24y8zfVNZQQhM8sjurCgsMNAizCDuKxE6CA"/>
<div class="absolute inset-0 bg-emerald-900/40 mix-blend-multiply"></div>
<div class="absolute inset-0 flex items-center justify-center p-6 text-center">
<p class="text-white text-sm font-medium leading-tight">"Efficiency is the byproduct of precision."</p>
</div>
</div>
</div>
</div>
