  ...
  <body class="bg-surface text-on-surface">
    ...
    >
      <div class="flex items-center gap-3 mb-10 px-2">
        ...
        <div>
          <h1
            class="text-xl font-bold text-emerald-800 dark:text-emerald-100 font-['Manrope'] tracking-tight"
          >
            Sovereign Ledger
          </h1>
          <p
            class="text-[10px] uppercase font-bold tracking-widest text-slate-400"
          >
            Institutional Grade
          </p>
        </div>
      ...
      <nav class="flex-1 space-y-2">
        <!-- Active: Dashboard -->
        <a
          class="flex items-center gap-3 p-3 text-emerald-700 dark:text-emerald-400 font-bold bg-white dark:bg-slate-800 shadow-sm rounded-lg translate-x-1 transition-transform font-['Manrope'] tracking-tight"
          href="#"
        >
        ...
        <a
          class="flex items-center gap-3 p-3 text-slate-500 dark:text-slate-400 hover:text-emerald-600 hover:bg-slate-200/50 dark:hover:bg-slate-800/50 transition-colors font-['Manrope'] tracking-tight"
          href="#"
        >
    ...
    >
      <div class="flex items-center flex-1 max-w-xl">
        <div
          class="relative w-full focus-within:ring-2 focus-within:ring-emerald-500/20 rounded-lg"
        >
          <span
      ...
      <div class="flex items-center gap-4 ml-6">
        <button
          class="p-2 text-slate-500 hover:text-emerald-500 transition-colors relative"
        >
    ...
    <main class="ml-64 p-8 min-h-screen">
      ...
      <div class="mb-10">
        ...
        <p class="text-on-surface-variant font-body">
          Real-time oversight of the Sovereign Ledger ecosystem.
        </p>
      </div>
      <!-- KPI Cards Grid -->
      <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-10">
        ...
        >
          <div class="flex justify-between items-start mb-4">
            <span
              class="text-label-sm font-bold text-slate-400 uppercase tracking-widest text-[10px]"
              >Total Balance</span
            >
            <div
      ...
      <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          ...
          >
            ...
            >
              ...
              <path
                ...
                d="M0,250 Q100,200 200,220 T400,150 T600,100 T800,80 L800,300 L0,300 Z"
              ></path>
              <path
                class="text-primary"
              ...
              <!-- Expense Path -->
              <path
                class="fill-tertiary/5"
                d="M0,280 Q150,260 300,270 T450,220 T600,240 T800,200 L800,300 L0,300 Z"
              ></path>
              <path
                class="text-tertiary"
                d="M0,280 Q150,260 300,270 T450,220 T600,240 T800,200"
                fill="none"
                stroke="currentColor"
                stroke-width="3"
              ></path>
        ...
        <div class="lg:col-span-4 space-y-6">
          <!-- Recent Alerts -->
          <div
            class="bg-surface-container-lowest rounded-xl p-6 shadow-[0px_4px_20px_rgba(0,0,0,0.02)]"
          >
            <h4
              class="text-sm font-bold font-headline mb-4 uppercase tracking-widest text-slate-400"
            >
              Critical Alerts
            </h4>
            <div class="space-y-4">
              <div
                class="flex gap-4 p-3 rounded-lg hover:bg-surface-container-low transition-colors group"
              >
                <div
                ...
                <div>
                  ...
                  <p class="text-xs text-slate-500 mt-1">
                    Acme Corp account flagged for $250k unusual activity.
                  </p>
          ...
          >
            ...
            <div class="space-y-4">
              <div class="flex justify-between items-center">
                ...
                <span class="text-sm font-bold text-primary">$12,400</span>
              </div>
              <div class="flex justify-between items-center">
                <div>
                  <p class="text-xs font-semibold text-slate-400">
                ...
                <span class="text-sm font-bold text-primary">$450,000</span>
              </div>
              <button
    ...
    >
      <div class="flex gap-6">
        <span class="font-['Inter'] text-xs text-slate-400"
          >© 2024 The Sovereign Ledger. All rights reserved.</span
        >
      </div>
      <div class="flex gap-6 font-['Inter'] text-xs text-slate-400">
        <span
          class="hover:text-slate-600 dark:hover:text-slate-200 cursor-pointer"
          >Version 2.4.1</span
        >
        <span
          class="hover:text-slate-600 dark:hover:text-slate-200 cursor-pointer"
